...
import {
  DiagnosticSolutionGetAll,
  DiagnosticSolutionUpdate,
  DiagnosticUpdate,
  DiagnoticCreate,
...
export class DiagnosticService implements IDiagnosticService {
  public async create(data: DiagnoticCreate): Promise<ApiResponse<Diagnostic>> {
    try {
      const { data: response } = await axios.post<ApiResponse<Diagnostic>>(
        `${process.env.API_URL || ""}/api/diagnostic/create`,
        data
      );
      return response;
    } catch (error: any) {
  ...
  public async getAll(): Promise<ApiResponse<Diagnostic[]>> {
    try {
      const { data: response } = await axios.get<ApiResponse<Diagnostic[]>>(
        `${process.env.API_URL || ""}/api/diagnostic/getAll`
      );
      return response;
    } catch (error: any) {
      return { error: parseError(error) };
  ...
  public async getAllData(): Promise<ApiResponse<DiagnosticSolutionGetAll[]>> {
    try {
      const { data: response } = await axios.get<
        ApiResponse<DiagnosticSolutionGetAll[]>
      >(`${process.env.API_URL || ""}/api/diagnostic/getAll`);
      return response;
    } catch (error: any) {
      return { error: parseError(error) };
  ...
  public async solutionDiagnostic(
    diagnosticSolution: DiagnosticSolutionUpdate
  ): Promise<ApiResponse<Diagnostic>> {
    try {
      const { data: response } = await axios.put<ApiResponse<Diagnostic>>(
        `${process.env.API_URL || ""}/api/diagnostic/solutionDiagnostic`,
        diagnosticSolution
      );
      return response;
    } catch (error: any) {
  ...
  public async updateById(
    ...
    try {
      const { data: response } = await axios.put<ApiResponse<Diagnostic>>(
        `${process.env.API_URL || ""}/api/diagnostic/updateById`,
        diagnosticUpdate
      );
      return response;
    } catch (error: any) {
