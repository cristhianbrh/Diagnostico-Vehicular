...
import { DiagnosticSolutionGetAll, DiagnosticSolutionUpdate, DiagnosticUpdate, DiagnoticCreate } from "@/types/diagnostic.type";
...
export interface IDiagnosticService {
    ...
    getAllData(): Promise<ApiResponse<DiagnosticSolutionGetAll[]>>
}